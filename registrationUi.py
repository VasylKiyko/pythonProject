...
class Ui_RegisterWindow(object):
    def setupUi(self, Ui_Registration):
        ...
        self.btnSingUpReg.setStyleSheet("QPushButton {\n"
                                        ...
                                        "}")
        shadowBtn = QGraphicsDropShadowEffect()
        shadowBtn.setColor(QColor(33, 147, 90))
        shadowBtn.setXOffset(0)
        shadowBtn.setYOffset(3.0)
        shadowBtn.setBlurRadius(3.0)
        self.btnSingUpReg.setGraphicsEffect(shadowBtn)
        self.btnSingUpReg.setObjectName("btnSingUpReg")
        self.leName = QtWidgets.QLineEdit(self.centralwidget)
        self.leName.setGeometry(QtCore.QRect(110, 70, 130, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.leSurname.setGeometry(QtCore.QRect(260, 70, 130, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.lePassword.setGeometry(QtCore.QRect(110, 150, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.leConPassword.setGeometry(QtCore.QRect(110, 190, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.label_6.setGeometry(QtCore.QRect(200, 39, 101, 25))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.leAddress.setGeometry(QtCore.QRect(110, 230, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.leApartNum.setGeometry(QtCore.QRect(110, 270, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.leLogin.setGeometry(QtCore.QRect(110, 110, 281, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        ...
        self.lMessage = QtWidgets.QLabel(self.centralwidget)
        self.lMessage.setGeometry(QtCore.QRect(190, 310, 121, 16))
        self.lMessage.setStyleSheet("color: red")
